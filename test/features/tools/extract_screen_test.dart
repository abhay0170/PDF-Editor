...
import 'package:pdf_reader/features/tools/extract/presentation/extract_screen.dart';
  ...
  testWidgets('shows the document picker before any document is chosen', (tester) async {
    await tester.pumpWidget(
      ProviderScope(
        ...
        child: const MaterialApp(home: ExtractScreen()),
      ),
    );
    await tester.pump();
    ...
    // Page-range input only appears once a document is selected.
    expect(find.text('Pages to extract'), findsNothing);
  });
}
