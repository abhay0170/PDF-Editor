...
import 'package:pdf_reader/features/tools/ocr/presentation/ocr_screen.dart';
...
void main() {
  testWidgets('shows the document picker before any document is chosen', (tester) async {
    ...
    // The disclosure note only appears once a document is selected.
    expect(find.textContaining('Recognizes text'), findsNothing);
  });
}
